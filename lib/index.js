...
Client.prototype.downloadFile = function(params, opts = { mkdirp: true }) {
  var self = this;
  ...
  function doTheDownload(cb) {
    ...
    request.on('httpHeaders', function(statusCode, headers, resp) {
      ...
      if (headers['content-length'] == undefined) {
        var outStream = fs.createWriteStream(localFile, {flags:'a'});
